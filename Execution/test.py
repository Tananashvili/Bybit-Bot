...
# Get latest z-score
def get_latest_zscore(ticker_1, ticker_2, starting_zscore, target_zscore, closing_zscore, stop_loss, count):
...
while True:
    msg_status, position_status = get_latest_zscore(symbols[0], symbols[1], starting_zscore, target_zscore, closing_zscore, stop_loss, count)
    if msg_status:
        break
